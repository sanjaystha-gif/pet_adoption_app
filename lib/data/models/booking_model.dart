...
class BookingModel extends BookingEntity {
  ...
  factory BookingModel.fromJson(Map<String, dynamic> json) {
    ...
    return BookingModel(
      ...
      userName: safeString(json['userName'] ?? json['user_name']),
      userEmail: safeString(json['userEmail'] ?? json['user_email']),
      userPhone: safeString(json['userPhone'] ?? json['user_phone']),
      petId: safeString(json['petId'] ?? json['pet_id']),
      petName: safeString(json['petName'] ?? json['pet_name']),
      petImageUrl: safeString(json['petImageUrl'] ?? json['pet_image_url']),
